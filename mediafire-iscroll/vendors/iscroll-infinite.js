...
// INSERT POINT: _wheel
	...
	reorderInfinite: function () {
		...
		while ( i < this.infiniteLength ) {
            ...
            var itemIdexVal = parseInt(this.infiniteElements[i].getAttribute("data-name"));
    ...
    /*if(Math.abs(Math.floor(this.maxScrollY/this.infiniteHeight)) === this.options.infiniteLimit) {
      console.log("indise")
