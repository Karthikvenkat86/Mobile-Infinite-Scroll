    ...
    function Rusha(sizeHint) {
        ...
        var resize = function(size) {
            ...
            if(ArrayBuffer)
                ...
                self.heap = new Array(nextPow2(padlen(size) + 320));
            self.core = RushaCore({
        ...
        var coreCall = function(len) {
            if(Int32Array)
                ...
                var h = new Array(self.heap, len << 2, 5);
            h[0] = 1732584193;
            h[1] = -271733879;
            h[2] = -1732584194;
            h[3] = 271733878;
        ...
        var rawDigest = this.rawDigest = function(str) {
            ...
            if(Int32Array)
                ...
                var view = new Array(self.heap, 0, padlen(len) >> 2);
            padZeroes(view, len);
            conv(str, view, len);
            padData(view, len);
            ...
            if(Int32Array)
              ...
              return new Array(self.heap, 0, 5);  
        };
